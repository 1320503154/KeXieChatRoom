...
<template>
	<div class="room">
		...
		<div class="intent-area">
			<input class="input input-alt" placeholder="请发送你的消息!" required="" v-model="chatmsg" type="text"
				@keyup.enter="AddMsg()" />
...
.room {
	...
	background-image: linear-gradient(to bottom right, transparent, mistyrose),url("public/聊天网页背景.png") ;
